...
D = 1.0e-3 -- Distance between two wires
...
function run_magnetic_analysis()
  ...
  add_wire(-D/2, RW, "I1", RESOLUTION)
  add_wire(D/2, RW, "I2", RESOLUTION)
  add_region_kelvin(R_IN, R_EX)
  mi_zoomnatural()

  -- Run the simulation
  mi_modifycircprop("I1", CURRENT, 1)
  mi_modifycircprop("I2", CURRENT, 1)
  mi_analyze()
